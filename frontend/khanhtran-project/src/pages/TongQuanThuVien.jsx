...
export default function tongquanthuvien() {
  return (
    <div className="about-container">
      ...
      <p className="italic">3. Cơ sở vật chất</p>
      <p className="text">
      ...
      <p className="italic">4. Đối tượng phục vụ</p>
      <p className="text">
      ...
      <p className="italic">5. Hệ thống & công nghệ</p>
      <p className="text">
      ...
      <p className="italic">6. Hệ thống & công nghệ</p>
      <p className="text">
      ...
      <p className="italic">7. Thông tin cơ bản</p>
      <p className="text">
